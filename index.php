...
<body class="spinner spinner-primary spinner-lg">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 footer-links">
                   <h4>About</h4>
                    <ul>
                        ...
                        <li><i class="fa fa-angle-right"></i><a href="#">Desclaimer</a></li>
                        <li><i class="fa fa-angle-right"></i><a href="#">Privecy Policy</a></li>
                ...
                <div class="col-lg-4 col-md-4 footer-contact">
                    <h4>Contact Us</h4>
                    <p>24 Block D <br>
                    Sipaipara, Rajshahi <br>
                    Bangladesh <br>
                    <strong>Phone:</strong> +880 1759 813264 <br>
                    <strong>Email:</strong> shprediction@gmail.com <br>
                    </p>
    ...
    <div class="container">
        <div class="copyright">
            Copyright &copy; by <a href="#"> Md. Asiqul Islam</a>. All Right Reserved from 2019-2025.
        </div>
        <div class="credits">
            Designed by <a href="#"> Md. Asiqul Islam</a>
        </div>
    </div>
